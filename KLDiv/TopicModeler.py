...
def inferTopicsTesting(label, topic_num):
	args=['./infertopicstesting.sh', "../Data/cleaned", "./malletstuff/testingdocs.csv"]
	subprocess.call(args)
	fixMalletOutputInf("./malletstuff/testingdocs.csv", "./malletstuff/alldocs.csv", topic_num)
